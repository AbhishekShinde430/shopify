...
public class Constats {
    ...
    public static  String LD_UID = "Guest";
    public static  String appPackage = "";
    public static  String appName = "";
    public static  String versionCode = "";


    public  static String selectedIndex="0";
    public static String checkStats="";
    public static Font FONT_TITLE = new Font(Font.FontFamily.TIMES_ROMAN, 22,Font.BOLD);
    public static Font FONT_SUBTITLE = new Font(Font.FontFamily.TIMES_ROMAN, 14,Font.BOLD);
